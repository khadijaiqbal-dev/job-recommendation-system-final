        ...
        <div className="card mb-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <input type="text" name="search" placeholder="Job title, company..." className="input-field" value={filters.search} onChange={handleFilterChange} />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Location</label>
              <input type="text" name="location" placeholder="City, state..." className="input-field" value={filters.location} onChange={handleFilterChange} />
            </div>
            <div>
            ...
            <div>
              ...
              <select name="salary" className="input-field" value={filters.salary} onChange={handleFilterChange}>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      {job.isNew && <span className="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded">New</span>}
                    </div>
                  ...
                  <div className="ml-6 flex flex-col space-y-2">
                    <button onClick={() => handleApplyClick(job)} className="btn-primary whitespace-nowrap">
                      Apply Now
                    </button>
                    <button className="btn-secondary whitespace-nowrap">Save Job</button>
                    <button onClick={() => handleViewDetails(job.id)} className="text-gray-500 hover:text-gray-700 text-sm">
                      View Details
                    </button>
                  </div>
                </div>
