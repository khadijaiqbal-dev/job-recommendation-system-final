...
const ApplicationManagement = () => {
  ...
  // debouncedFilters is what actually triggers the fetch
  ...
  // Debounce the jobId text input by 400ms; status and page changes fire immediately
  useEffect(() => {
  ...
  const fetchApplications = useCallback(async () => {
    try {
      ...
      if (debouncedFilters.jobId)
        queryParams.append("jobId", debouncedFilters.jobId);
      queryParams.append("page", debouncedFilters.page);
      queryParams.append("limit", "10");

      const response = await fetch(
        `/api/applications/admin/all?${queryParams}`,
        {
          headers: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            >
              ...
              <option value="SHORT_LISTED_BY_COMPANY">
                Short Listed by Company
              </option>
                  ...
                  <tr key={app.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <button
                        ...
                        className="text-[#003659] hover:text-[#003659] mr-4"
                      >
                        Update Status
                      </button>
                    </td>
        ...
        {pagination.pages > 1 && (
          <div className="bg-gray-50 px-4 py-3 flex items-center justify-between border-t border-gray-200">
            <div className="text-sm text-gray-700">
              Showing page {pagination.current} of {pagination.pages} (Total:{" "}
              {pagination.total})
            </div>
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                  ...
                  <p>
                    ...
                    <span
                      className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(selectedApplication.status)}`}
                    >
                  ...
                  <div className="space-y-2">
                    {statusHistory.map((entry) => (
                      <div key={entry.id} className="text-sm">
                        <div className="flex items-center justify-between">
                          <span
                            className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(entry.newStatus)}`}
                          >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  >
                    ...
                    <option value="CALL_FOR_INTERVIEW">
                      Call for Interview
                    </option>
                    <option value="SELECTED">Selected</option>
                    <option value="REJECTED">Rejected</option>
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  ...
                  <button
                    ...
                    disabled={
                      !newStatus || newStatus === selectedApplication.status
                    }
